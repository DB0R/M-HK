...
#قناة المطور @AMRAKL
ob_start();
$token = '6914441661:AAECkrFlWRlC5JYDfyTX2xmoOfBwkRskAAw'; #توكن بوتك
...
$admin ="7143725479"; # ايدي المطور
$adminuz ="bbbottah"; #معرف الادمن دون @
$chas = "2079367664"; #ايدي قناة الاثبات
$chas2 = "hgfdvjhcgj"; #معرف قناة إثبات
$sudo = array("$admin","7143725479","7143725479"); #ايدهات الادمن 
...
'parse_mode'=>"markdown",
 ...
 elseif($data == 'sales'){
  ...
  bot('editMessageText',[
   'chat_id'=>$chat_id,
   'message_id'=>$message_id,
   'text'=>"- تم ارسال طلبك لمالك البوت ، ✨\nقم بمراسلته لينفذ طلبك ... @$adminuz"
  ]);
  bot('sendmessage',[
   'chat_id'=>$admin,
